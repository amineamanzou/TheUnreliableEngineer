...
export const homepageFr = {
  ...
  hero: {
    ...
    sticky: {
      ...
      body:
        "Une voix éditoriale assumée pour parler de fiabilité, d'observabilité et de stratégie infra sans jprivate-deploy-controllern de brochure.",
    },
    persona: {
  ...
  contact: {
    ...
    bullets: [
      ...
      "Une attente d'exécution avec du jugement, pas de théâtre ni de jprivate-deploy-controllern décoratif",
    ],
    primaryCta: {
      label: "Prendre un rendez-vous",
      href: "#top",
